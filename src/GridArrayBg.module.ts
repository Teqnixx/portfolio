        ...
        },
        {
          ...
          value: function (t) {
            ...
            for (var r = 0, n = 0, s = e.length; n < s; n += i)
              R.fromArray(e, n),
                (r = Math.max(r, this.bounds.center.squaredDistance(R)));
          ...
          value: function () {
            ...
            this.gl.renderer.state.currentProgram === this.id ||
              ...
              this.uniformLocations.forEach(function (e, i) {
                ...
                if (s.value.texture)
                  return (r += 1), s.value.update(r), D(t.gl, i.type, e, r);
    ...
    return n(
      function t() {
        ...
        (this.dpr = l),
          ...
          (this.autoClear = A),
          (this.id = j++),
          2 === F && (this.gl = n.getContext("webgl2", R)),
          (this.isWebgl2 = !!this.gl),
          this.gl || (this.gl = n.getContext("webgl", R)),
          this.gl,
          ...
          value: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : this._target;
            return V(this._target, t), this.onChange(), this;
          },
        },
        {
          key: "multiply",
...
var Pt = (function () {
  ...
  Ot = (function (t) {
    function r() {
      ...
      return (
        i(this, r),
        ((t = e(this, r, [n, 6])).name = "grid-array"),
        (t.speed = 56),
        t.start(),
        t
      );
      ...
      n(r, [
        {
          ...
          value: function () {
            (this.rtt = new yt(this.gl, {
              width: 2 * this.canvasW,
              height: 2 * this.canvasH,
            })),
              ...
              (this.rttProgram = new U(this.gl, {
                ...
                uniforms: {
                  u_time: { value: 0 },
                  u_resolution: {
                    value: new St(2 * this.canvasH, 2 * this.canvasH),
                  },
                  ...
                  u_rotateCanvas: { value: 0 },
                  u_rotateUnit: { value: 0 },
        ...
        },
        {
          ...
          value: function (t, e) {
            switch (t) {
              case "scale":
                this.rttProgram.uniforms.u_scale.value = parseFloat(e);
                break;
              case "size":
                this.rttProgram.uniforms.u_size.value = [
                  parseFloat(e),
                  parseFloat(e),
                ];
                break;
              case "u_w":
                (this.rttProgram.uniforms.u_w.value = parseFloat(e)),
                  (this.rttProgram.uniforms.u_x.value =
                    (1 - parseFloat(e)) / 2);
                break;
              case "u_h":
                (this.rttProgram.uniforms.u_h.value = parseFloat(e)),
                  (this.rttProgram.uniforms.u_y.value =
                    (1 - parseFloat(e)) / 2);
                break;
              case "amplitude":
                this.rttProgram.uniforms.u_amplitude.value = parseFloat(e);
                break;
              case "radius":
                this.rttProgram.uniforms.u_radius.value = parseFloat(e);
                break;
              case "borderwidth":
                this.rttProgram.uniforms.u_borderwidth.value = parseFloat(e);
                break;
              case "rotateCanvas":
                this.rttProgram.uniforms.u_rotateCanvas.value = parseFloat(e);
                break;
              case "rotateUnit":
                this.rttProgram.uniforms.u_rotateUnit.value = parseFloat(e);
                break;
              case "speed":
                var i = parseFloat(e);
                this.speed = -11 * i + 111;
