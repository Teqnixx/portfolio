  ...
  return (
    <>
      ...
      <section className='border-t-1 border-barline'>
        <div className='max-w-screen-2xl py-8 px-5 sm:px-8 lg:px-16 mx-auto text-white'>
          <div className='block md:flex justify-between'>
            ...
            <div className='sm:w-full md:max-w-sm lg:max-w-md flex justify-between mt-4 sm:mt-0'>
        ...
        <hr className='max-w-screen-2xl py-8 px-5 sm:px-8 lg:px-16 mx-auto ' />
      </section>
    </>
  )
}
